<%-- 
    Document   : MenuBar_Marketing
    Created on : Jun 4, 2023, 12:57:06 PM
    Author     : dinhd513
--%>
...
<section id="sidebar">
    <a href="" class="brand">
        ...
        <span class="text" style="font-family: 'MuseoModerno', cursive; margin: 30px;font-size: 40px">Front:</span>
    </a>
